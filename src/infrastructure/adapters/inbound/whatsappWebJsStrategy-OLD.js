...
// Adapters para WhatsAppAdministrator
const StructuredLoggerAdapter = require('../outbound/logging/StructuredLoggerAdapter');
...
class WhatsAppWebJsStrategy extends WhatsAppInterface {
    ...
    constructor(webSocket, connectionId = null, tenantId = null) {
        ...
        // ChatService - Usando factory con inyección de dependencias
        this.chatService = ChatServiceFactory.create(webSocket);
        ...
        try{
            ...
            if (isAdminMessage) {
                ...
                if (!this.whatsAppAdmin) {
                    ...
                    // Crear todas las dependencias necesarias para WhatsAppAdministrator
                    const logger = new StructuredLoggerAdapter();
                    const tradingRepository = new TradingRepositoryImpl();
                    const customerService = new CustomerService();

                    // Crear TradingAdapter con sus dependencias
                    ...
                    // Inyectar todas las dependencias usando el nuevo constructor
                    this.whatsAppAdmin = new WhatsAppAdministrator({
                        logger: logger,
                    ...
                    structuredLogger.info('WhatsAppWebJsStrategy', 'WhatsAppAdministrator initialized with dependency injection', {
                        messageFrom: message.from,
                        hasLogger: !!logger,
                        hasTradingRepository: !!tradingRepository,
